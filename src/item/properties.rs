...
pub type PropertyValues = [u32; MAX_PROPERTY_VALUES];

#[derive(Clone, Debug)]
pub struct PropertyDef {
    pub id: u16,
    pub text: String,
    pub values: [ValueDef; MAX_PROPERTY_VALUES],
}
...
impl MapPropertyDb {
    ...
    pub fn new() -> Self {
        ...
        db.add(PropertyDef::new(0, "{:+d} to Strength", defs![8(32)]));
        ...
        db.add(PropertyDef::new(74, "+{:d} Replenish Life", defs![6(30)]));
        ...
        db.add(PropertyDef::new(80, "{:d}% Better Chance of Getting Magic Items", defs![10(300)]));
